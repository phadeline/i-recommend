...
function Recommendations({ genreName, Token, songName }) {
  ...
  useEffect(() => {
    const FetchAllGenres = async () => {
       ...
       let urls = [`https://api.music.apple.com/v1/catalog/us/search?types=songs&limit=25&term=${genreName[0]}`, `https://api.music.apple.com/v1/catalog/us/search?types=songs&limit=25&term=${genreName[0]}`]
